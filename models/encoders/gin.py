...
class GINEncoder(torch.nn.Module):
    ...
    def __init__(self, hidden_dim, num_convs=3, activation='relu', short_cut=True, concat_hidden=False, input_dim=5,
                 time_emb=True):
        super().__init__()
        ...
        self.emblin = nn.Linear(self.input_dim, hidden_dim)  # 16 or 8
    ...
    def forward(self, z, edge_index, edge_attr):
        ...
        if z.dim() == 1 and z.dtype == torch.long:
            ...
            if self.time_emb:
                ...
                node_attr = self.emblin(z) + temb
            else:
                node_attr = self.emblin(z)  # for one-hot feature

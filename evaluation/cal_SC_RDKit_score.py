...
# ref_mol = Chem.SDMolSupplier('./data/8h6tcut6/ref.sdf')[0]
ref_mol = Chem.SDMolSupplier('./data/8h6tcut6/8h6t_ligand_revised.sdf')[0]
mol = Chem.SDMolSupplier('./data/8h6tcut6/select/-8.4_8h6t_9021_revised.sdf')[0]
print(calc_SC_RDKit_score(mol, ref_mol))
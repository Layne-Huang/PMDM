...
crossdock_with_pocket = {
    'name': 'crossdock',
    'atom_index': {1: 0, 6: 1, 7: 2, 8: 3, 9: 4, 15: 5, 16: 6, 17: 7, 34: 8, 119: 9},
    'atom_encoder': {'H': 0, 'C': 1, 'N': 2, 'O': 3, 'F': 4, 'P': 5, 'S': 6, 'Cl': 7, 'Se': 8, 'others': 9},
    'atom_decoder': ['H', 'C', 'N', 'O', 'F', 'P', 'S', 'Cl', 'Se', 'others'],
    'n_nodes': {27: 5423, 20: 4887, 28: 4840, 26: 4717, 25: 4537, 21: 4500, 23: 4379, 24: 3716, 30: 3605,
                31: 3371, 22: 3346, 32: 3336, 29: 3245, 16: 3098, 19: 3095, 11: 3055, 12: 2902, 10: 2866,
                33: 2689, 18: 2624, 14: 2471, 17: 2450, 15: 2297, 13: 2168, 34: 2168, 35: 1881, 9: 1860,
                36: 1388, 8: 1043, 37: 931, 38: 916, 39: 752, 6: 709, 40: 691, 44: 691, 7: 655, 41: 630,
...
def get_dataset_info(dataset_name, remove_h):
    if dataset_name == 'qm9':
        ...
        if not remove_h:
            ...
            raise Exception('Missing config for %s without hydrogens' % dataset_name)
    elif dataset_name == 'crossdock_pocket':
        if not remove_h:
            return crossdock_with_pocket
        else:
            raise Exception('Missing config for %s without hydrogens' % dataset_name)

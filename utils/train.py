...
#     if cfg.type == 'adam':
#         d1_params = list(map(id, model.diffusion_1.parameters()))
#         d2_params = list(map(id, model.diffusion_2.parameters()))
#         base_params = filter(lambda p: id(p) not in d1_params and id(p) not in d2_params, model.parameters())
#         return torch.optim.AdamW([{'params':base_params},{'params':model.diffusion_1.parameters(), 'lr':1.e-5},
#         {'params':model.diffusion_2.parameters(), 'lr':1.e-4}],
#             lr=cfg.lr,
